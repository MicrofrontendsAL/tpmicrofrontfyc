...
/***/ "./node_modules/single-spa-svelte/lib/single-spa-svelte.js":
/*!*****************************************************************!*\
  !*** ./node_modules/single-spa-svelte/lib/single-spa-svelte.js ***!
  \*****************************************************************/
...
/* harmony import */ var home_ticket__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! home/ticket */ "webpack/container/remote/home/ticket");
/* harmony import */ var home_ticket__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(home_ticket__WEBPACK_IMPORTED_MODULE_1__);
...
function create_fragment(ctx) {
	...
	return {
		c() {
			...
			if (!(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.src_url_equal)(img.src, img_src_value = (home_ticket__WEBPACK_IMPORTED_MODULE_1___default())[/*image*/ ctx[0]].image)) (0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.attr)(img, "src", img_src_value);
		...
		p(ctx, [dirty]) {
			if (dirty & /*image*/ 1 && !(0,svelte_internal__WEBPACK_IMPORTED_MODULE_0__.src_url_equal)(img.src, img_src_value = (home_ticket__WEBPACK_IMPORTED_MODULE_1___default())[/*image*/ ctx[0]].image)) {
...
function instance($$self, $$props, $$invalidate) {
	let image = (displayTicket_displayTicket__WEBPACK_IMPORTED_MODULE_2___default().image);

	displayTicket_displayTicket__WEBPACK_IMPORTED_MODULE_2___default().subscribe(() => {
		$$invalidate(0, image = (displayTicket_displayTicket__WEBPACK_IMPORTED_MODULE_2___default().image));
	});

	const addToCart = () => {
		displayTicket_displayTicket__WEBPACK_IMPORTED_MODULE_2___default().incrementCount();
	};
